import { $, $$, audio, toast, NB } from "./core.js?v=39";
import { initWorld, skipIntro, setWorld } from "./world3d.js?v=39";
import { setScene, startLoop, hint, procedure, resetActive, setInspect, pointer } from "./labs.js?v=39";
import {
