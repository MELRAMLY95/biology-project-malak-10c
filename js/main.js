import { $, $$, audio, toast, NB } from "./core.js?v=42";
import { initWorld, skipIntro, setWorld } from "./world3d.js?v=42";
import { setScene, startLoop, hint, procedure, resetActive, setInspect, pointer } from "./labs.js?v=42";
import {
